// Sistema Velodesk - Versão de Teste
...
// Teste de funções - adicionar ao window para garantir acesso global
window.fazerLogin = fazerLogin;
window.navigateToPage = navigateToPage;
window.navigateToPageMobile = navigateToPageMobile;
window.loadDashboardStats = loadDashboardStats;
window.loadBoxes = loadBoxes;
window.createKanbanBox = createKanbanBox;
window.createTicketElement = createTicketElement;
window.createDefaultKanbanBoxes = createDefaultKanbanBoxes;
window.openTicket = openTicket;
window.createNewTicket = createNewTicket;
window.openNewBoxModal = openNewBoxModal;
window.createDefaultBoxes = createDefaultBoxes;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('fazerLogin:', typeof fazerLogin);
    console.log('createNewTicket:', typeof createNewTicket);
    console.log('openNewBoxModal:', typeof openNewBoxModal);
    console.log('createDefaultBoxes:', typeof createDefaultBoxes);
    console.log('refreshTickets:', typeof refreshTickets);
