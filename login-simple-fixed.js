...
function createTicketTab(ticket, box) {
    ...
    // Garantir que a classe está aplicada após criar a aba
    const ticketsPage = document.getElementById('tickets');
    if (ticketsPage) {
    ...
    return `
        <div class="ticket-tab-ticket-view">
                    ...
                    <div class="sidebar-section client-info-section">
                        ...
                        <div class="client-fields">
                            <div class="form-field">
                                ...
                                <input type="text" class="form-input" id="clientName-${ticket.id}" placeholder="Nome do cliente" value="${ticket.clientName || ''}">
                            </div>
                            <div class="form-field">
                                <label>CPF</label>
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" class="form-input" id="responsibleAgent-${ticket.id}" placeholder="Nome do responsável" value="${ticket.responsibleAgent || ''}">
                            </div>
            ...
            <div class="ticket-tab-footer-fixed">
                <div class="ticket-tab-footer-actions">
...
function closeTicketTab(tabId) {
    ...
    if (listTab) {
        ...
        // Se não houver mais abas, criar a aba Lista novamente
        const tabsBar = document.getElementById('ticketTabsBar');
        const tabsContent = document.querySelector('.ticket-tabs-content');
        
        const tabItem = document.createElement('div');
        tabItem.className = 'ticket-tab-item active';
        tabItem.setAttribute('data-tab', 'list');
        tabItem.onclick = () => switchTicketTab('list');
        tabItem.innerHTML = '';
        tabsBar.appendChild(tabItem);
        ...
        tabContent.innerHTML = '<div class="tickets-list" id="ticketsList"><div class="no-selection">Selecione uma caixa para ver os tickets ou crie um novo ticket</div></div>';
        tabsContent.appendChild(tabContent);
